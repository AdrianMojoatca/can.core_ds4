...
/*==========================================================================*/
// $Id: nvfs.find_entry.c 33258 2015-08-19 12:46:35Z martin.bouchard $
/*==========================================================================*/
...
static UInt16  fetch_list_root (void) ;

static Boolean test_match (NVFS_Entry_Name const entry_name , NVFS_Entry_Link * const nvfs_entry_link) ;
...
{
  UInt16 loc_entry_addr      = fetch_list_root () ; 
  ...
  while (loc_entry_addr)
    {
      ...
      if (test_match (entry_name , & nvfs_entry.link.name))
        {
