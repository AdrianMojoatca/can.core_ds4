...
/*==========================================================================*/
// $Id: prog_init.c 24019 2013-12-18 14:23:07Z louis-philippe.rispoli $
/*==========================================================================*/
...
static Boolean prog_init_hy_canada (void) ;
static void    prog_set_runtime    (void * arg) ;
...
static Boolean prog_init_hy_canada (void)
{
  static const Cmd_Array2 cmd_array[] = 
    {        
      ...
      {INPUT_LOCK1          | INPUT_ON, prog_input_change_custom1option1, EXEC_MODE_PROG                } ,
      {INPUT_LOCK2          | INPUT_ON, prog_input_change_custom1option1, EXEC_MODE_PROG                } ,
      {INPUT_LOCK3          | INPUT_ON, prog_input_change_custom1option1, EXEC_MODE_PROG                } ,
      {INPUT_OEM_LOCK                 , prog_input_change_custom1option1, EXEC_MODE_PROG                } ,

      {INPUT_UNLOCK_ALL1    | INPUT_ON, prog_input_change_custom1option2, EXEC_MODE_PROG                } ,
      {INPUT_UNLOCK_ALL2    | INPUT_ON, prog_input_change_custom1option2, EXEC_MODE_PROG                } ,
      {INPUT_UNLOCK_ALL3    | INPUT_ON, prog_input_change_custom1option2, EXEC_MODE_PROG                } ,
      {INPUT_UNLOCK_DRIVER1 | INPUT_ON, prog_input_change_custom1option2, EXEC_MODE_PROG                } ,
      {INPUT_UNLOCK_DRIVER2 | INPUT_ON, prog_input_change_custom1option2, EXEC_MODE_PROG                } ,
      {INPUT_UNLOCK_DRIVER3 | INPUT_ON, prog_input_change_custom1option2, EXEC_MODE_PROG                } ,
      {INPUT_OEM_UNLOCK               , prog_input_change_custom1option2, EXEC_MODE_PROG                } ,

      {INPUT_START          | INPUT_ON, prog_input_change_custom1option3, EXEC_MODE_PROG                } ,
	  {INPUT_TRUNK        	| INPUT_ON, prog_input_change_custom1option3, EXEC_MODE_PROG                } ,
	  {INPUT_OEM_TRUNK                , prog_input_change_custom1option3, EXEC_MODE_PROG                } ,
   };
