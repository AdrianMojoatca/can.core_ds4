...
/*==========================================================================*/
// $Id: config.h 33258 2015-08-19 12:46:35Z martin.bouchard $
/*==========================================================================*/
...
#define FW_VERSION      APP_VERSION

// <h>  Device Configuration
// <o0> Target device <0=> LPC-2364 <1=> LPC-2366 <2=> LPC-2368
// <o1> Target crystal frequency (Hz) <00000000-25000000>
// <o2> Target CPU clock speed   (Hz) <00000000-75000000>
// </h>

#define DEV_TYPE                    0  // LPC2364 = 0 , DEV_LPC2366 = 1 , DEV_LPC2368 = 2

#define XTAL_OSC_HZ          12000000  // Frequency of external crystal in Hz

#define CPU_CLOCK_HZ         72000000  // CPU Clock Speed in Hz

#if DEV_TYPE != 0 && DEV_TYPE != 1 && DEV_TYPE != 2
