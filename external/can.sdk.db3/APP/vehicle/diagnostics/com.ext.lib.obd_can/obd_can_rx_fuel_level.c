...
/*==========================================================================*/
// $Id: obd_can_rx_fuel_level.c 33257 2015-08-19 12:45:49Z martin.bouchard $
/*==========================================================================*/
...
Boolean obd_can_rx_fuel_level (Obd_Can_Rx_Msg * obd_can_rx_msg)
{
  #define DATA(z) obd_can_rx_msg->data[z]
	    ...
	    engine.fuel_level  = DATA(1) * 100 / 255 ;    // updated fuel level
	
	#if STATUS_FUEL_LVL_ENABLE > 0	
		sense_notify_fuel_lvl( engine.fuel_level);
	#endif
...
#if DBG_OBD_CAN == 1
  dbg_tx_text("*** obd_can_rx_fuel_level = ");
  dbg_tx_h16(engine.fuel_level);
  dbg_tx_text("\r\n");
#endif
