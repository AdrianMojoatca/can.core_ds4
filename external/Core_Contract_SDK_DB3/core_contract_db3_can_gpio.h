#ifndef __CORE_CONTRACT_DB3_CAN_GPIO_H__
#define __CORE_CONTRACT_DB3_CAN_GPIO_H__
...
typedef enum
{
    CORE_DB3_CAN_GPIO_IRQ_FT_RX = 0,
    CORE_DB3_CAN_GPIO_IRQ_SW_RX,
    CORE_DB3_CAN_GPIO_IRQ_HS_RX,
    CORE_DB3_CAN_GPIO_IRQ_J1850_RX
} core_db3_can_gpio_irq_pin_t;

static void core_contract_db3_can_gpio_mode0_set(Boolean is_high)
{
    if (is_high)
    {
...
static void core_contract_db3_can_gpio_mode1_set(Boolean is_high)
{
    if (is_high)
    {
...
static void core_contract_db3_can_gpio_prepare_sw_tx(void)
{
    core_contract_db3_can_gpio_mode0_set(TRUE);
    core_contract_db3_can_gpio_mode1_set(TRUE);
    gpio_pl_direction(GPIO_PL_J1850_TX_NU);
    gpio_pl_direction(GPIO_PL_CAN_SW_TX);
}

static void core_contract_db3_can_gpio_ft_enable(Boolean is_enabled)
{
    if (is_enabled)
    {
...
static void core_contract_db3_can_gpio_ft_standby(Boolean is_enabled)
{
    if (is_enabled)
    {
...
static void core_contract_db3_can_gpio_hs_active(Boolean is_active)
{
    if (is_active)
    {
...
static void core_contract_db3_can_gpio_irq_gpio_enable(core_db3_can_gpio_irq_pin_t irq_pin)
{
    switch (irq_pin)
    {
        case CORE_DB3_CAN_GPIO_IRQ_FT_RX:
...
static Boolean core_contract_db3_can_gpio_irq_falling_stat(core_db3_can_gpio_irq_pin_t irq_pin)
{
    switch (irq_pin)
    {
        case CORE_DB3_CAN_GPIO_IRQ_FT_RX:
...
#endif /* __CORE_CONTRACT_DB3_CAN_GPIO_H__ */