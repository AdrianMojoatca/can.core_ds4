/*<#======================================================================#>*/
/*              CONTRACT WRAPPER PENTRU CONFIG_OBD_CAN.H (DB3)              */
/*<#======================================================================#>*/
...
void core_contract_db3_obd_can_config_init_defaults(void);
void core_contract_db3_obd_can_config_init_vehicle_specific(void);
