/*<#======================================================================#>*/
/*               CONTRACT WRAPPER PENTRU CONFIG_PROG.H (DB3)             */
/*<#======================================================================#>*/

#ifndef __CORE_CONTRACT_DB3_PROG_CONFIG_H__
#define __CORE_CONTRACT_DB3_PROG_CONFIG_H__
...
void core_contract_db3_prog_config_init_defaults(void);
void core_contract_db3_prog_config_init_vehicle_specific(void);

#endif /* __CORE_CONTRACT_DB3_PROG_CONFIG_H__ */
